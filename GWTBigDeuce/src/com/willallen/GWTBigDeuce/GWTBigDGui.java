package com.willallen.GWTBigDeuce;
...
import com.willallen.GWTBigDeuce.client.card;
import com.willallen.GWTBigDeuce.client.deck;
import com.willallen.GWTBigDeuce.client.Hand;
import com.willallen.GWTBigDeuce.client.tableHand;
import com.willallen.GWTBigDeuce.shared.FieldVerifier;

public class GWTBigDGui implements EntryPoint
{
	//http://code.google.com/webtoolkit/tools/gwtdesigner/palettes/gwt_palette.html
	...
	private void onModuleLoadOld()
	{
		...
		for (int m = 0; m < arrayOfcard.length; m++)
		{
			...
			this.btnSouthPlayPanel[m].addClickHandler((ClickHandler) this);
		}
		...
		for (int n = 0; n < arrayOfcard.length; n++)
		{
			...
			this.btnSouthTempPanel[n].addClickHandler((ClickHandler) this);
		...
		this.cntrBottomPanel = new Grid(); // 1,5
		...
		this.cntrBottomPanel.add(this.btnNew = new Button("New Game"));
		this.btnNew.addClickHandler((ClickHandler) (this));
		this.cntrBottomPanel.add(this.btnPass = new Button("Pass Turn"));
		this.btnPass.addClickHandler((ClickHandler) (this));
		this.cntrBottomPanel.add(this.btnSend = new Button("Send Up"));
		this.btnSend.addClickHandler((ClickHandler) (this));
		this.cntrBottomPanel.add(this.btnExit = new Button("Exit Game"));
		this.btnExit.addClickHandler((ClickHandler) (this));
